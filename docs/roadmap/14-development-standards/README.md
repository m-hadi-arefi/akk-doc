...
- [Technology Principles](../../knowledge/standards/technology-principles.md) — Fundamental engineering rules and architectural disciplines.
- [Clean Code & Programming Standards](../../knowledge/programming/overview.md) — SOLID, OOP, and code readability practices.
